...
function Pengumuman() {
    ...
    const { isLoading, error, addAnnouncement } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useAnnouncementStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
    const open = ()=>{
        setDialogOpen(true);
    };
    const close = ()=>{
